...
class Privilege extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Privilege', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PrivilegeService'), createEmptyInstance: create)
    ...
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'asignPrivileges', protoName: 'asignPrivileges')
  ...
  @$pb.TagNumber(5)
  $core.bool get asignPrivileges => $_getBF(4);
  @$pb.TagNumber(5)
  set asignPrivileges($core.bool v) { $_setBool(4, v); }
  @$pb.TagNumber(5)
  $core.bool hasAsignPrivileges() => $_has(4);
  @$pb.TagNumber(5)
  void clearAsignPrivileges() => clearField(5);
