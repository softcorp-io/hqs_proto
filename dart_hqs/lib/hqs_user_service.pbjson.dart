...
const Token$json = const {
  ...
  '2': const [
    ...
    const {'1': 'errors', '3': 4, '4': 3, '5': 11, '6': '.hqs.Error', '10': 'errors'},
  ],
};
...
const Response$json = const {
  '1': 'Response',
  '2': const [
    const {'1': 'user', '3': 1, '4': 1, '5': 11, '6': '.hqs.User', '10': 'user'},
    const {'1': 'users', '3': 3, '4': 3, '5': 11, '6': '.hqs.User', '10': 'users'},
    const {'1': 'errors', '3': 4, '4': 3, '5': 11, '6': '.hqs.Error', '10': 'errors'},
...
const AuthHistory$json = const {
  '1': 'AuthHistory',
  '2': const [
    const {'1': 'authHistory', '3': 1, '4': 3, '5': 11, '6': '.hqs.Auth', '10': 'authHistory'},
  ],
};
