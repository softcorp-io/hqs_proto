...
type Privilege struct {
	...
	AssignPrivileges       bool                 `protobuf:"varint,5,opt,name=assignPrivileges,proto3" json:"assignPrivileges,omitempty"`
...
func (x *Privilege) GetAssignPrivileges() bool {
	if x != nil {
		return x.AssignPrivileges
	}
	return false
}
...
var file_hqs_privilege_service_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x12, 0x2a, 0x0a, 0x10, 0x61, 0x73, 0x73, 0x69, 0x67, 0x6e,
	0x50, 0x72, 0x69, 0x76, 0x69, 0x6c, 0x65, 0x67, 0x65, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x10, 0x61, 0x73, 0x73, 0x69, 0x67, 0x6e, 0x50, 0x72, 0x69, 0x76, 0x69, 0x6c, 0x65, 0x67,
